...
public class CulturalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(CulturalActivity.this,
        ...
        mySpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> arg0, View view,
                ...
                switch (position) {
                    case 1:
                        intent = new Intent(CulturalActivity.this, CulturalActivity.class);
                        startActivity(intent);
                        break;
                    case 2:
                        intent = new Intent(CulturalActivity.this, EcologicalActivity.class);
                        startActivity(intent);
                        break;
                    case 3:
                        intent = new Intent(CulturalActivity.this, AdventureActivity.class);
                        startActivity(intent);
                        break;

                    case 4:
                        intent = new Intent(CulturalActivity.this, SportsActivity.class);
                        startActivity(intent);
                        break;
    ...
    private void configureMenuButton(){
        ...
        menu_button.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                startActivity(new Intent(CulturalActivity.this, mainMenu.class));
            }
        });
    }
